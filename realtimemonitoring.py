...
# Global variables to control packet capture
...
def process_packet(packet):
    global request_counts, packet_data, all_captured_packets
    ...
    try:
        if packet.haslayer(IP):
            ...
            all_captured_packets.append(info)  # Store in all captured packets
    ...
    def save():
        try:
            with open(file_path, "w", newline="") as csvfile:
                ...
                writer.writerow(["Source IP", "Destination IP", "Source Port", "Destination Port", "Protocol Number", "Length", "Payload Length"])
...
for col in columns:
    ...
    packet_tree.column(col, width=190)  # Adjust width as needed
